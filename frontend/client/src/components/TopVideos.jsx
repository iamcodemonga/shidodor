    ...
    return (
        <section id="videos">
            <div className="container">
                    ...
                    {videos && videos.map((video, index) => <div className="col-sm-12 col-md-12 col-lg-6 col-xl-4 col-xxl-4" key={video.id}>
                        <Link className="video-card-link h-100" to={`/video/${video.uid}`}>
                            <div className="video-card">
                                <img className="w-100 h-100" src={`${REACT_APP_API_ROOT}/${video.thumbnail}`} alt='Top_video' />
                ...
                <p>
                    <Link className="btn btn-dark border rounded-pill border-0 see-all-btn px-3" role="button" to="/videos">see more</Link>
                </p>
            </div>
        </section>
    )
