...
export default function OtherSongs({ songs }) {
        ...
        <section className="recommended-section">
            <div className="container">
                ...
                <div className="row gx-5 gy-2">
                    {songs && songs.map((song, index) => <div className="col-sm-12 col-md-12 col-lg-6 col-xl-3 col-xxl-3" key={song.id}>
                        <Link className="song-card-link" to={`/song/${song.uid}`} >
                            <div className="song-card-B">
                                ...
                                <img className="w-100 h-100" src={`${REACT_APP_API_ROOT}/${song.art}`} alt='related_song'/>
