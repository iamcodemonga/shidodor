...
export default function OtherAlbums({ albums }) {
        ...
        <section className="recommended-section">
            <div className="container">
                ...
                <div className="row gx-5 gy-5">
                    {albums && albums.map((album) => <div className="col-sm-12 col-md-12 col-lg-6 col-xl-3 col-xxl-3" key={album.id}>
                        <Link className="album-card-link" to={`/album/${album.uid}`}>
                            <div className="album-card">
                                ...
                                <img className="w-100 h-100" src={`${REACT_APP_API_ROOT}/${album.art}`} alt='related_album'/>
